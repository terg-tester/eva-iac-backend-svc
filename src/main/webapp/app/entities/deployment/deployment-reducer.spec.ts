...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPLOYMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DEPLOYMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DEPLOYMENT actions', async () => {
      const arg = { id: 12768 };
    ...
    it('dispatches UPDATE_DEPLOYMENT actions', async () => {
      const arg = { id: 12768 };
    ...
    it('dispatches PARTIAL_UPDATE_DEPLOYMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DEPLOYMENT actions', async () => {
      const arg = 42666;
