...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './artifact.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTIFACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTIFACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTIFACT actions', async () => {
      const arg = { id: 14401 };
    ...
    it('dispatches UPDATE_ARTIFACT actions', async () => {
      const arg = { id: 14401 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTIFACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTIFACT actions', async () => {
      const arg = 42666;
