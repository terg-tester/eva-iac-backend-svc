  ...
  return (
    <div>
      <h2 id="project-heading" data-cy="ProjectHeading">
        <Translate contentKey="evagApp.project.home.title">Projects</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evagApp.project.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/project/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="evagApp.project.home.createLabel">Create new Project</Translate>
          </Link>
        </div>
      </h2>
        ...
        {projectList && projectList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="evagApp.project.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="evagApp.project.name">Name</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('name')} />
                </th>
                ...
                <th>
                  <Translate contentKey="evagApp.project.createdBy">Created By</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {projectList.map((project, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`evagApp.ProjectStatus.${project.status}`} />
                  </td>
                  <td>
                    <Translate contentKey={`evagApp.Priority.${project.priority}`} />
                  </td>
                  ...
                  <td>{project.createdDate ? <TextFormat type="date" value={project.createdDate} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>
                    {project.lastModifiedDate ? <TextFormat type="date" value={project.lastModifiedDate} format={APP_DATE_FORMAT} /> : null}
                  </td>
                  <td>{project.addendum}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evagApp.project.home.notFound">No Projects found</Translate>
            </div>
          )
        )}
      </div>
