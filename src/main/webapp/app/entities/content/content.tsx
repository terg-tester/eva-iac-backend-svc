  ...
  return (
    <div>
      <h2 id="content-heading" data-cy="ContentHeading">
        <Translate contentKey="evagApp.content.home.title">Contents</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="evagApp.content.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/content/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="evagApp.content.home.createLabel">Create new Content</Translate>
          </Link>
        </div>
      </h2>
        ...
        {contentList && contentList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="evagApp.content.id">Id</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
              ...
              {contentList.map((content, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {content.content ? (
                      <div>
                        {content.contentContentType ? (
                          <a onClick={openFile(content.contentContentType, content.content)}>
                            <Translate contentKey="entity.action.open">Open</Translate>
                            &nbsp;
                          </a>
                        ) : null}
                        <span>
                          {content.contentContentType}, {byteSize(content.content)}
                        </span>
                      </div>
                    ) : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="evagApp.content.home.notFound">No Contents found</Translate>
            </div>
          )
        )}
      </div>
