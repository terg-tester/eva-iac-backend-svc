...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './content.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches CREATE_CONTENT actions', async () => {
      const arg = { id: '4dd1e232-4125-4f33-9d38-5c4e65096fc6' };
