...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DELIVERABLE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DELIVERABLE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DELIVERABLE actions', async () => {
      const arg = { id: 204 };
    ...
    it('dispatches UPDATE_DELIVERABLE actions', async () => {
      const arg = { id: 204 };
    ...
    it('dispatches PARTIAL_UPDATE_DELIVERABLE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DELIVERABLE actions', async () => {
      const arg = 42666;
